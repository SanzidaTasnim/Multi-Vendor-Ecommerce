				...
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
					<div class="col mx-auto">
						<div class="mb-4 text-center">
							<img src="{{asset('adminBackend/assets/images/logo-img.png')}}" width="180" alt="SignIn_logo" />
						</div>
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="text-center">
										<h3 class="">Sign in <span style="color: darkred; font-size: 16px;display: inline-block; transform: translateY(-3px); font-weight: bold;">as</span> Vendor</h3>
